...
const TaskDetailMonitor = ({ location, history }) => {
  ...
  const {
    podName, type: typeFromQuery, timeRange: timeChangeFromQuery, monitor = 'basic',
  } = query;
  ...
  const src = useMemo(() => {
    ...
    const {
      type, timeRange, refresh, container,
    } = formData;
    ...
    <PageWithBreadcrumb>
      ...
      >
        ...
        }
        {
          ...
          <TabPane tab="Serverless" key="serverless">
        ...
        }
        {
          ...
          <TabPane tab="Memcached" key="memcached">
