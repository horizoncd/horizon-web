export default {
  ...
  'pages.slo.overview': 'Overview',
  'pages.slo.env': 'Environment',
  'pages.slo.env.test': 'Test',
  'pages.slo.env.online': 'Online',
  'pages.slo.history': 'History',
  'pages.slo.time': 'Time',
  'pages.slo.last.1h': 'Last 1h',
  'pages.slo.last.3h': 'Last 3h',
  'pages.slo.last.6h': 'Last 6h',
  'pages.slo.last.12h': 'Last 12h',
  'pages.slo.last.1d': 'Last 1 day',
  'pages.slo.last.3d': 'Last 3 days',
  'pages.slo.last.1w': 'Last 1 week',
  'pages.slo.last.1mon': 'Last 1 month',
  'pages.slo.custom': 'Custom',
