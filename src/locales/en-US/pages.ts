export default {
  ...
  'pages.cluster.basic.pipeline.unmerged.description': 'Unreleased count during the latest PRs',
  ...
  'pages.pipeline.unmerged': 'Unreleased',
  ...
  'pages.pipeline.mergeStatus.ready': 'Ready to release',
  ...
  'pages.pipeline.mergeStatus.pending.description': 'This release has not passed the checks yet. If the release is urgently required, please contact the system administrator to force merge and proceed with the release',
  'pages.pipeline.mergeStatus.merged': 'Released',
