export default {
  ...
  'pages.header.clusters': 'Application Instances',
  ...
  'pages.common.appinstance': 'Application Instance',
  ...
  'pages.pods.autoDeploy': 'Automatic batch deploy',
  'pages.pods.cancelAutoDeploy': 'Cancel automatic batch deploy',
  'pages.pods.deployCancel': 'Cancel',
  'pages.pods.unpause': 'Unpause',
  'pages.pods.buildLog': 'Pipelinerun log',
  'pages.message.cluster.autoDeploy.success': 'Set auto deploy successfully',
  'pages.message.cluster.autoDeployCancel.success': 'Cancel auto deploy successfully',
  'pages.message.cluster.autoDeploy.description': 'Automatically batch release, automatically release the next batch according to the batch configuration, can be turned off after being turned on.',
  ...
  'pages.groups.newapplication': 'New application',
  'pages.groups.New group': 'New group',
  'pages.groups.New cluster': 'New application instance',
  'pages.groups.copy cluster': 'Copy application instance',
  ...
  'pages.navigation.switchToV1': 'Old mode',
  'pages.navigation.application': 'Inherited application',
  'pages.navigation.application.desc': 'Create application instance by inheriting configurations of application',
  'pages.navigation.appType': 'Application type',
  'pages.navigation.instanceType': 'Application Instance type',
  'pages.navigation.catalog': 'Developer Catalog',
  'pages.navigation.catalog.desc': 'Create application by predefined templates, deploy database or middleware with a few inputs',
  'pages.navigation.gitImport': 'Import from git',
  'pages.navigation.gitImport.desc': 'Import source code from git, build and deploy it on Horizon',
  'pages.navigation.imageDeploy': 'Deploy image',
  'pages.navigation.imageDeploy.desc': 'Deploy existing image to Horizon',
  'pages.catalog.middleware': 'Middleware',
  'pages.catalog.database': 'Database',
  'pages.catalog.workload': 'Workload',
  'pages.catalog.v1': 'Older Version',
  'pages.catalog.other': 'Other',
  ...
  'pages.applicationDetail.basic.createCluster': 'Create application instance',
  ...
  'pages.cluster.id': 'Instance ID',
  'pages.clusterNew.config.application': 'Config',
  'pages.clusterNew.config.pipeline': 'Build config',
  'pages.clusterNew.success': 'Create application instance successfully',
  'pages.clusterNew.header': 'Creating instance for [ {application} ], please fill in the information step by step',
  'pages.clusterNew.step.one': 'Basic',
  'pages.clusterNew.step.two': 'Config',
  'pages.clusterNew.step.three': 'Audit',
  'pages.clusterNew.tpl.select': 'Template',
  'pages.clusterNew.basic': 'Basic',
  'pages.clusterNew.tpl.config': 'Config',
  'pages.clusterNew.review': 'Audit',
  'pages.clusterNew.step.message': 'Step {index}',
  'pages.clusterNew.basic.title': 'Aplication Instance Basic',
  'pages.clusterNew.basic.name.ruleMessage': 'The instance name is required, which supports letters, numbers and dashes, and should start with a letter',
  ...
  'pages.clusterEdit.success': 'Update application instance successfully',
  'pages.clusterEdit.prompt.buildDeploy.title': 'Do you want to run build and deploy?',
  'pages.clusterEdit.prompt.buildDeploy.create.content': 'Build and deploy: Pull code to run build and then deploy your instance based on artifacts.',
  ...
  'pages.clusterEdit.prompt.deploy.create.content': 'Deploy: Deploy your instance with the latest configuration based on artifacts',
  'pages.clusterEdit.prompt.deploy.edit.content': 'Run deploy again to publish your latest configuration.',

  'pages.clusterDetail.basic.detail': 'Instance details',
  'pages.clusterDetail.basic.config': 'Instance configs',
  'pages.clusterDetail.basic.name': 'Name',
  'pages.clusterDetail.basic.description': 'Description',
  'pages.clusterDetail.basic.template': 'Template',
  ...
  'pages.clusterDetail.basic.image': 'Image',
  ...
  'pages.clusterDelete.success': 'Delete instance successfully',
  'pages.clusterDelete.confirm.title': 'Are you sure to delete this application instance: {cluster}?',
  'pages.clusterDelete.confirm.content': 'Warning: the application instance could not be resumed after deleted',
  ...
  'pages.cluster.status.pipelineRunning': 'Pipeline running',
  ...
  'pages.cluster.status.ready': 'Ready to Merge',
  'pages.cluster.status.pending': 'Pending',
  ...
  'pages.cluster.podsTable.nodata.desc': 'No Pod found, possibly due to replica count being scaled down to 0 or the instance not being deployed, please check replica count in instance\'s configuration and cluster status.',
  ...
  'pages.cluster.podsTable.ready': 'Ready',
  'pages.cluster.podsTable.ready.unknown.description': 'Readiness probe not configured yet, online status unknown',
  'pages.cluster.podsTable.container.ready': 'Ready',
  'pages.cluster.podsTable.ready.notready': 'Not Ready',
  ...
  'pages.pipeline.status.running': 'Running',
  ...
  'pages.pipeline.buildLog': 'Pipelinerun log',
  'pages.pipeline.mergeStatus.ready': 'Ready to merge',
  'pages.pipeline.mergeStatus.ready.description': 'This release has passed all checks and is ready to proceed with the release process.',
  'pages.pipeline.mergeStatus.pending': 'Pending',
  'pages.pipeline.mergeStatus.pending.description': 'This release has not passed the checks yet. If the release is urgently required, please contact the system administrator or PE to force merge and proceed with the release',
  'pages.pipeline.mergeStatus.merged': 'Merged',
  'pages.pipeline.mergeStatus.merged.description': 'This release has been merged',
  ...
  'pages.pipeline.merge.confirm': 'Confirm Merge',
  'pages.pipeline.merge.confirm.force': 'Force Merge',
  ...
  'pages.cluster.members.title': 'Application instance members',
  ...
  'pages.template.type': 'Type',
  'pages.template.type.extra': 'Type of template, Older Version is not recommended, Workload notes kubernetes workload',
  ...
  'pages.message.tags.tooltip': 'For tags whose key or value exceeds 16 characters, please check it on the application instance homepage.',
  ...
  'pages.message.expireTime.hint': 'Configure the duration of the application instance. The expired instance will be automatically freed, which configuration is retained and can be quickly deployed with one click',
  ...
  'pages.message.template.delete.content': 'This template may be being used by an application or instance. Please confirm it before deleting it',
  ...
  'pages.message.release.delete.content': 'This release may be being used by an application or instance. Please confirm it before deleting it',
  ...
  'pages.message.defaultRegion.hint': 'You can configure the default region for different environments. When you create an application instance for a environment, the default region for the environment is automatically populated',
  'pages.message.defaultRegion.success': 'The default region is updated successfully',
  'pages.message.cluster.free.hint': 'The application instance has been freed and its configuration has been reserved. You can quickly deploy it by clicking [Build and deploy] or [Deploy]',
  'pages.message.cluster.ttl.hint': 'The expiration time is calculated in real time based on the latest operation time, and the expired application instance will be automatically freed',
  'pages.message.cluster.status.desc': `Creating: The application instance is being created, do not perform operations
    Healthy: The application instance is deployed normally
    Unhealthy: The application instance is in an abnormal state
    Unreleased: The application instance has not been deployed
    Deploying: The application instance is being deployed
    Freed: The application instance's resources have been freed, similar to state [no deploy], and can be rebuilt
  ...
  'pages.message.cluster.free.confirm': 'Are you sure to free the application instance?',
  'pages.message.cluster.free.content': 'Destroy all pods and return resources, preserving the application instance configuration',
  'pages.message.cluster.free.process': 'Start freeing the application instance...',
  'pages.message.cluster.resume.hint': 'The application instance is in a manually paused state, and the operation takes effect after the pause is unpaused',
  'pages.message.cluster.delete.confirm': 'Are you sure to delete the application instance?',
  'pages.message.cluster.delete.content': 'Once deleted, the data cannot be recovered',
  'pages.message.cluster.delete.process': 'Start deleting the application instance',
  'pages.message.cluster.delete.freeFirst': 'Please free the application instance before deleting it',
  ...
  'pages.message.cluster.deployCancel.first.content1': 'This application instance is being deployed for the first time.',
  ...
  'pages.message.cluster.pipeline.unmerged.description': 'count of unmerged pipelines',
  ...
  'pages.message.pods.lifeCycle.containerStartup': 'Failed to start, please check your code and the application instance configuration(Health check -> startup) and view Events for the detail errors',
  'pages.message.pods.lifeCycle.containerOnline': 'Service online failed. Please check the application instance configuration(Health check -> online) and view Events for the detail errors',
  'pages.message.pods.lifeCycle.healthCheck': 'Health check failed. Please check the application instance configuration(Health check -> check/status) and view Events for the detail errors',
  'pages.message.pods.lifeCycle.default': 'Execution failed. Please contact your administrator.',
  'pages.message.pods.lifeCycle.preStop': 'Service is going offline. Please check the application instance configuration(Health check -> offline) if it takes a long time',
  ...
  'pages.message.environment.autoFree.extra': 'System automatically releases the application instances after the specified expiration time',
  ...
  'pages.message.k8s.disabled.extra': 'Disable for maintenance or offline, After disable, you cannot select the k8s when creating an application instance',
  ...
  'pages.noData.templates.desc': 'Template is used for Horizon to create an application or instance, which includes CI/CD process',
  ...
  'pages.noData.region.desc': 'Region refers to the deployment destination for applications and instances. It is necessary to configure the K8S information corresponding to the region',
  'pages.noData.cluster.title': 'An application instance is a deployment instance of a specific application',
  'pages.noData.cluster.desc': `You can deploy your application instance to various environments (test , online, etc.)
    and regions (Hangzhou, Singapore, etc.). The instance inherits the configuration of the application,
    and of course, you can modify most of the configuration and grant different permissions of the instance to different people,
  ...
  'pages.noData.release.cluster.desc': 'Show all application instances using this release',
