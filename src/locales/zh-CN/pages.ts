export default {
  ...
  'pages.header.more': '更多',
  'pages.header.more.slo': 'SLO',
  'pages.header.more.admin': '管理员',
  ...
  'pages.cluster.basic.podsNum': 'Pods数量',
  ...
  'pages.cluster.podsTable.podStatus': 'Pod 状态',
  ...
  'pages.template.recommended.no': '非推荐版本',
  ...
  'pages.message.pods.tip1.content1.1': '1.1【 Stdout 】: 查看启动日志中是否有异常信息',
  'pages.message.pods.tip1.content1.2': '1.2【 Mlog 】: 查看Mlog是否有异常日志',
  'pages.message.pods.tip1.content1.3': '1.3【 Events 】: 查看事件列表中是否有Warning类型的事件',
  ...
  'pages.message.pods.reschedule.content': '此操作将导致所有被选中的Pod（共{number}台）在优雅停机后被销毁，并创建出同等数量的新Pod，请注意评估流量风险！',
  'pages.message.pods.reschedule.hint': '优雅停机并销毁被选中的Pod，并创建出同等数量的新Pod',
