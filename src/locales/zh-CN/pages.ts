export default {
  ...
  'pages.clusterNew.basic.title': '应用实例基础信息',
  'pages.clusterNew.basic.name.ruleMessage': '实例名是必填项，支持字母、数字和中划线的组合，且必须以字母开头',
  'pages.clusterNew.basic.name': '应用实例名',
  'pages.clusterNew.basic.description': '应用实例描述',
