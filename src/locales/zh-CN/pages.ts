export default {
  ...
  'pages.cluster.status.ready': '等待合入',
  ...
  'pages.pipeline.mergeStatus.ready': '等待合入',
  'pages.pipeline.mergeStatus.ready.description': '本次发布已通过所有检查，准备执行发布流程',
  'pages.pipeline.mergeStatus.pending': '等待检查',
  'pages.pipeline.mergeStatus.pending.description': '本次发布暂未通过检查，如果发布需求紧急， 请联系系统管理员或者PE强制合入执行发布',
  'pages.pipeline.mergeStatus.merged': '已合入',
  'pages.pipeline.mergeStatus.merged.description': '本次发布已合入',
