export default {
  ...
  'pages.message.groups.delete.hint': '需要将当前组下应用和集群清空之后，才能删除当前组, 分组删除后无法恢复',
  ...
  'pages.message.tags.tooltip': '键/值长度超过16个字符的标签请到集群主页查看',
  ...
  'pages.message.expireTime.hint': '配置集群的使用时长，到期后集群会自动释放，配置保留，可一键快速拉起',
  ...
  'pages.message.template.delete.content': '该模板有可能正在被应用或集群使用，删除前请确认',
  ...
  'pages.message.release.delete.content': '该模板版本有可能正在被应用或集群使用，删除前请确认',
  ...
  'pages.message.defaultRegion.hint': '可以针对不同的环境配置该环境的默认部署区域。在创建对应环境的集群时，区域会自动填充为该环境默认的部署区域',
  'pages.message.defaultRegion.success': '默认区域更新成功',
  'pages.message.cluster.free.hint': '集群已释放，配置保留，点击构建发布或直接发布可一键快速拉起',
  'pages.message.cluster.ttl.hint': '根据最近操作时间实时计算，到期后会自动释放集群',
  'pages.message.cluster.status.desc': `创建中：集群正在创建中，请勿操作
    正常： 集群已正常发布
    异常： 集群处于异常状态
    未发布： 集群尚未发布
    发布中： 集群正在发布中
  ...
  'pages.message.cluster.free.content': '销毁所有pod并归还资源，保留集群配置',
  'pages.message.cluster.free.process': '开始释放集群...',
  'pages.message.cluster.resume.hint': '该集群处于人工暂停状态，该操作会在取消暂停之后生效',
  'pages.message.cluster.delete.confirm': '确定删除集群?',
  'pages.message.cluster.delete.content': '删除后，数据将无法恢复',
  'pages.message.cluster.delete.process': '开始删除集群',
  'pages.message.cluster.delete.freeFirst': '请先释放集群，再进行删除',
  'pages.message.cluster.deployCancel.confirm': '确定要取消发布？',
  'pages.message.cluster.deployCancel.content': '将跳转到流水线页面，选择目标流水线回滚以取消当前发布',
  'pages.message.cluster.deployCancel.first.content1': '当前集群是第一次发布，',
  'pages.message.cluster.deployCancel.first.content2': '取消发布将直接释放集群',
  'pages.message.cluster.deployCancel.success': '取消发布成功',
  'pages.message.cluster.deployCancel.first.success': '取消发布成功，开始释放集群',
  ...
  'pages.message.pods.tip2.content1': '集群处于',
  ...
  'pages.message.pods.lifeCycle.containerStartup': '启动失败，请检查业务代码或者集群自定义配置（健康检查->port、存活状态）是否正确，具体报错信息可查看日志和events。',
  'pages.message.pods.lifeCycle.containerOnline': '上线失败，请检查集群自定义配置（健康检查->上线接口）是否正确，具体报错信息可查看events。',
  'pages.message.pods.lifeCycle.healthCheck': '健康检查失败，请检查集群自定义配置（健康检查->存活状态/就绪状态）是否正确，具体报错信息可查看events。',
  'pages.message.pods.lifeCycle.default': '执行失败，请联系管理员。',
  'pages.message.pods.lifeCycle.preStop': '应用正在下线中，若耗时较长，请检查集群自定义配置（健康检查->下线接口）是否配置有误。',

  'pages.message.environment.name.extra': '环境唯一名称标识',
  'pages.message.environment.displayName.extra': '系统内部展示名称，一般可填为中文名',
  'pages.message.environment.autoFree.extra': '开启后，系统会在指定过期时间后自动释放该环境下的集群',
