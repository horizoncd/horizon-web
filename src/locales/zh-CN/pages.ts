export default {
  ...
  'pages.application.transfer': '转移',
  'pages.application.transfer.message': '请选择一个Group',
  'pages.application.transfer.desc': `将当前应用迁移到另外一个组，操作者必须是另外组的PE、Owner或者Maintainer`,
